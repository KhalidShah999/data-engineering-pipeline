...
├── data_engineering_pipeline             # The main python package for the project
...
e.g: `cat data_engineering_pipeline/VERSION` will get the project version without harming
